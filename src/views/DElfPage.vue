    ...
    <div class="base-content-align">
      <div>
        ...
        <md-content class="note">
          <span class="note-content">You are currently edit hero Dark Elf.</span>
        </md-content>
      </div>
    </div>
  </div>
...
export default {
  computed: {
    getXPosData: {
      get: function () {
        return this.$store.getters.getDElfPageXPos
      },
      set: function (newValue) {
        this.$store.dispatch('setDElfPageXPos', newValue)
      }
    },
    getYPosData: {
      get: function () {
        return this.$store.getters.getDElfPageYPos
      },
      set: function (newValue) {
        this.$store.dispatch('setDElfPageYPos', newValue)
      }
    }
  }
}
