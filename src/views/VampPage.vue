    ...
    <div class="base-content-align">
      <div>
        ...
        <md-content class="note">
          <span class="note-content">You are currently edit hero Vampiress.</span>
        </md-content>
      </div>
    </div>
  </div>
...
export default {
  computed: {
    getXPosData: {
      get: function () {
        return this.$store.getters.getVampPageXPos
      },
      set: function (newValue) {
        this.$store.dispatch('setVampPageXPos', newValue)
      }
    },
    getYPosData: {
      get: function () {
        return this.$store.getters.getVampPageYPos
      },
      set: function (newValue) {
        this.$store.dispatch('setVampPageYPos', newValue)
      }
    }
  }
}
